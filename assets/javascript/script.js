...
$("#submit").on("click", function (event) {
    ...
    // Validate input and prevent from submitting empty form
    if(!nameInput || !destinationInput || !firstTrainInput || !frequencyInput){
        alert("All the fields must contain input!");
        return false;
    }
